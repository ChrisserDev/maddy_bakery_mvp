	...
	return (
		<footer className="site-footer">
			...
			<div className="footer-bottom">
				<p className="footer-note">Baked in Stevenage, Hertfordshire 🍞</p>
				<p className="footer-copy">© {currentYear} Maddy&apos;s Bakery. All rights reserved.</p>
				<p className="footer-copyright">
					Designed and Developed by Cristian Serban 
					<a href="https://www.linkedin.com/in/cristianserban24/" target="_blank" rel="noopener noreferrer" className="linkedin-link">
						<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style={{verticalAlign: 'middle', marginLeft: '8px'}}>
